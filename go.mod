module github.com/rancher/gen-api-docs
...
require (
	...
	github.com/rancher/norman v0.0.0-20181031214002-0dbd45668f96
	...
	k8s.io/apiextensions-apiserver v0.0.0-20180621165922-80db67131e8d // indirect
	k8s.io/apimachinery v0.0.0-20180619225948-e386b2658ed2
	k8s.io/client-go v2.0.0-alpha.0.0.20180621152933-b0722d92a7c1+incompatible // indirect
	k8s.io/gengo v0.0.0-20180223161844-01a732e01d00 // indirect
	k8s.io/kube-openapi v0.0.0-20180509051136-39cb288412c4 // indirect
	k8s.io/kubernetes v1.10.5 // indirect
)
